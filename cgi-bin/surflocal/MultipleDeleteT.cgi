...
#####set variables here######
$newform = "/cgi-bin/surflocal/MultipleDeleteT.cgi";
$ButtonTemplate = "$basedir" . "Templates" . "/" . "TextAdTemplate.html";
...
sub DoTheDelete
{
	...
	foreach $Destination (@UploadTo)
	{
		...
		if ($Destination ne "")
		{
			$NewFile = $basedir . $Destination . "/" . "Text.data";
...
\"><br><br></center>\n";
	print "<h1><FONT COLOR=000000>WELL DONE ...</h1>\n";
...
sub SelectButton
{
	...
	close(TEMPFILE);
	$ButtonFile = "$basedir" . "$ThisCity" . "/" . "Text.data";#contains pipe-delimited data
...
print "<link href=\"/styleC.css\" rel=\"stylesheet\" type=\"text/css\" />\n";
        print "<center><img src=\"http://surflocal.net/\sm_banner_MKTG.jpg
\"><br><br></center>\n";
		print "<h1><FONT COLOR=000000>Select a text ad to delete</h1>\n";
		print "The text ad you select below will be deleted from all the cities you select on the next step.<br>\n";
...
print "<link href=\"/styleC.css\" rel=\"stylesheet\" type=\"text/css\" />\n";
        print "<center><img src=\"http://surflocal.net/\sm_banner_MKTG.jpg
\"><br><br></center>\n";
	print "<h1>Select the city that contains the TEXT AD you want to delete</h1>\n";
	print "Find the city where the TEXT AD you want to delete is. This TEXT AD MUST <b>";
	...
	print "to select the TEXT AD from a list of all the buttons in that city.<p>\n";
	print "<form action=$newform method=POST>\n";
...
sub SelectCityArray
{
	...
	&GetThisButton;
	&Header;
	open(CHOOSE,"$basedir" . "Templates" . "/" . "ChooseCities2T.html") || &Error("Can't open the cities file. Reason: $!");
	while(<CHOOSE>)
	{
		if ($_ =~ /\%\%ListOfCities\%\%/)
		{
...
sub GetThisButton
{
	$ButFile = $basedir. $City . "/" . "Text.data";
...
print "<link href=\"/styleC.css\" rel=\"stylesheet\" type=\"text/css\" />\n";
        print "<center><img src=\"http://surflocal.net/\sm_banner_MKTG.jpg
\"><br><br></center>\n";
	print "<h1><FONT COLOR=000000>I have saved your city selections</h1>\n";
