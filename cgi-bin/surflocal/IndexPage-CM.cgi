...
$IndexTemplate = "$TemplatesDir" . "/cities/IndexTemplate-CM.html";
...
$AdText</a>";
			...
			print "<a href=\"$AdDisp\" class=\"roll\"><font size=-1><b>

Childrens Musicals <br>
Future Products
</a>";
...
sub GenerateCategories
{
	...
	for ($i = 0; $i <= $Divided; $i++)
	{
		...
		if ($PrintedCells < $Cats)
		{
		    ...
		    print "<td WIDTH=183 HEIGHT=46 BGCOLOR=\"ffffff\" BACKGROUND=/images/btn-yellow-sn1.jpg><center>";
		    print "<a href=\"$CoupDisp\" class=\"roll\"><font color=000000><font size=-1><b>
...
$TheCategory</font></a>";
		...
		else
		{
		    ...
		    print "<td WIDTH=183 HEIGHT=46 BGCOLOR=\"ffffff\" BACKGROUND=/images/btn-yellow-sn1.jpg><center>";
		    print "<a href=\"$CoupDisp\" class=\"roll\"><font size=-1><b>
