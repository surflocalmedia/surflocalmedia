...
$Btext</font></a></td>\n";
			...
			$ThisLoop++;
				...
				$HandleUrl = "$HandleRequest" . "\?" . "Button" . "\&" . "$State" . "\&" . "$City";		
	       		 ...
	       		 print "<a href=\"$HandleUrl\">";
	       		 print "<font size=-1>Promote Local <br>Business</a>";
	       		 print "</td>\n";
				$BCells++;
				$ThisLoop++;
		    	}	    
...
$AdText</a>";
			...
			print "<a href=\"$AdDisp\" class=\"roll\"><font size=+1>Private Category 
...
Public Category <br>
    ...
    {
        print "<center><font color=000000>Click the link above to Start Your Coupon Ad</font></center>";
    }
}
