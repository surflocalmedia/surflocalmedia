...
$IndexTemplate = "$TemplatesDir" . "COINTL_ButtonTemp.html";
...
sub ButtonAds
{
    ...
    if ($NoButtons)
    {
    	...
    	{
    		 print "<td align='center' width='136' height='56' background='/images/5_7-out1.jpg'>";
	        print "<a href=\"$HandleUrl\">";
	        print "<font size=-1><font face=tahoma>Colorado Intl Pageant</a>";
	        print "</td>\n";
    	}
    }
    else
...
sub LocalProductAds
{
    ...
    if ($TextExists ne "false")
    {
		...
		until ($ThisLoop == 4)
		{
			...
			print "<a href=\"$AdDisp\" class=\"roll\">Colorado International Pageant</a>";
...
sub GenerateCategories
{
	...
	for ($i = 0; $i <= $Divided; $i++)
	{
		...
		else
		{
		    ...
		    print "<a href=\"$CoupDisp\" class=\"roll\">Colorado International Pageant</a>";
