...
$newform = "$baseurl" . "IndexPage.cgi";

$IndexTemplate = "$TemplatesDir" . "SHOPUS_ButtonTemp.html";
...
sub ButtonAds
{
    ...
    if ($NoButtons)
    {
    	...
    	{
    		 print "<td align='center' width='136' height='56' background='/images/2_1-out2.jpg'>";
	        print "<a href=\"$HandleUrl\">";
	        print "<font face=\"Tahoma
\"><font size=-1><b>Consumer Shopping Service</a></b>";
	        print "</td>\n";
    	}
    }
    else
	...
	$imgdr = "$baseurl" . "images";
		...
		until ($ThisLoop == 5)
		{
			...
			print "<a href=\"$Burl\"><font color=\"$Bfontcolor\" face=\"$Bfont\"><font size=-1><strong>$Btext</strong></font></a></td>\n";
			$BCells++;
			$ThisLoop++;
	    		}
	    		...
	    		{
				$HandleUrl = "$HandleRequest" . "\?" . "Button" . "\&" . "$State" . "\&" . "$City";		
	       		 print "<td align='center' width='136' height='56' background='/images/6_5-out1.jpg'>";
	       		 print "<a href=\"$HandleUrl\">";
	       		 print "<font face=\"Tahoma
\"><font size=-1><b>Consumer Shopping Service</a></b>";
	       		 print "</td>\n";
...
sub LocalProductAds
{
    ...
    if ($TextExists ne "false")
    {
		...
		until ($ThisLoop == 4)
		{
			...
			print "<td><center><font face=\"Tahoma
\"><b><font size=-1>";
...
sub GenerateCategories
{
	...
	for ($i = 0; $i <= $Divided; $i++)
	{
		...
		if ($PrintedCells < $Cats)
		{
		    ...
		    print "<td WIDTH=25\%><center><font face=\"Tahoma
\"><b><font size=-1>";
		    print "<a href=\"$CoupDisp\" class=\"roll\"><b><font color=FFFF00>$TheCategory</font></a></b>";
		...
		else
		{
		    ...
		    print "<td WIDTH=25\%><center><font face=\"Tahoma
\"><font size=-1>";
		    print "<a href=\"$CoupDisp\" class=\"roll\"><font color=FFFF00>Your category here</font></a>";
