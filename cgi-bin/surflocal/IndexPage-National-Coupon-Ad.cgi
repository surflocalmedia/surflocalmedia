...
$newform = "/cgi-bin/surflocal/IndexPage-National-Coupon-Ad.cgi";

$IndexTemplate = "$TemplatesDir" . "/cities/IndexTemplate-USA.html";
...
sub GenerateCategories
{
	...
	for ($i = 1; $i <= $Divided; $i++)
	{
		...
		if ($PrintedCells < $Cats)
		{
		    ...
		    print "<td WIDTH=183 HEIGHT=33 BACKGROUND=/images/btn-yellow-sn2.jpg><center>";
