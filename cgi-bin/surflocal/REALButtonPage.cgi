...
$IndexTemplate = "$TemplatesDir" . "REAL_ButtonTemp.html";
$CouponDisplay = "$baseurl" . "/cgi-bin/surflocal/CouponDisplay.cgi";
$HandleRequest = "$baseurl" . "/cgi-bin/surflocal/BeginAdDB.cgi";
...
sub ButtonAds
{
    ...
    if ($NoButtons)
    {
    	...
    	{
    		 print "<td align='center' width='136' height='56' background='$imgdr/5_4-out2.jpg'>";
	        print "<a href=\"$HandleUrl\">";
	        print "<font face=\"Arial\">Show Your Property Here</a>";
	        print "</td>\n";
    	}
    }
    else
...
sub LocalProductAds
{
    ...
    if ($TextExists ne "false")
    {
		...
		until ($ThisLoop == 4)
		{
			...
			print "<td><center><font face=\"Arial\"><b><font size=\-1>";
...
sub GenerateCategories
{
	...
	for ($i = 0; $i <= $Divided; $i++)
	{
		...
		if ($PrintedCells < $Cats)
		{
		    ...
		    print "<td WIDTH=25\%><center><font face=\"Arial\"><b><font size=-1>";
		...
		else
		{
		    ...
		    print "<td WIDTH=25\%><center><font face=\"Arial\"><font size=-1>";
