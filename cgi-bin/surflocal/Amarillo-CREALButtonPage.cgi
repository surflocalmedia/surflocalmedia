...
$newform = "/cgi-bin/surflocal/Amarillo-CREALButtonPage.cgi";

$IndexTemplate = "$TemplatesDir" . "Amarillo-CREAL_ButtonTemp.html";
...
sub ButtonAds
{
    ...
    if ($NoButtons)
    {
    	...
    	{
    		 print "<td align='center' width='136' height='56' background='$imgdr/1_6-out2.jpg'>";
	        print "<a href=\"$HandleUrl\">";
	        print "<font face=\"Georgia\">$City $State</a>";
	        print "</td>\n";
    	}
    }
    else
	...
	$imgdr = "$baseurl" . "images";
		...
		until ($ThisLoop == 5)
		{
			...
			print "<a href=\"$Burl\"><font color=\"$Bfontcolor\" face=\"$Bfont\"><font size=-1><b>$Btext</b></font></a></td>\n";
			$BCells++;
			$ThisLoop++;
	    		}
...
sub LocalProductAds
{
    ...
    if ($TextExists ne "false")
    {
		...
		until ($ThisLoop == 4)
		{
			...
			print "<a href=\"$AdDisp\" class=\"roll\">Self Serve Real Estate</a>";
...
sub GenerateCategories
{
	...
	for ($i = 0; $i <= $Divided; $i++)
	{
		...
		else
		{
		    ...
		    print "<a href=\"$CoupDisp\" class=\"roll\">Self Serve Real Estate</a>";
