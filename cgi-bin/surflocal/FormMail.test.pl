...
BEGIN
{
  ...
  $postmaster        = 'form@surflocal.net';
  @referers          = qw(surflocal.net 205.178.145.65);
  @allow_mail_to     = 'david@surflocal.net';
  @recipients        = ();
  %recipient_alias   = ();
...
<p>
  ...
  like this:
  <tt>&lt;form action=&quot;/cgi-bin/FormMail.testf.pl&quot; method=&quot;post&quot;&gt;</tt>
</p>
END
    return 0;
  }
...
sub send_main_email_header {
  ...
  my $subject = $self->{FormConfig}{subject} || 'test';
  if ($self->{CFG}{secure}) {
...
sub success_page_footer {
  ...
  print <<END;
        <hr size="1" width="75%" />
        Click <a href="http://TEIGLOBAL.COM ">here</a> to return to the site.
        </body>
       </html>
END
}
