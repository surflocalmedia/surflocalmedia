...
sub ExecuteEdit
{
	...
	&Header;
	&PHed;
        print "<center><img src=\"http://surflocal.net/\sm_banner_MKTG.jpg\"><br><br></center>\n";
...
sub MakeEdit
{
	...
	&OpenMyDatabase;
        print "<center><img src=\"http://surflocal.net/\sm_banner_MKTG.jpg\"><br><br></center>\n";	
	print "<h1><center>Edit your text ad's values</h1></center>\n";
...
sub TextAdUrl
{
	print "<center>Edit your text ad's url: <input type=text name=$EditItem value=\"$ThisItem\">\n";
}
...
sub PrintJabber
{
        ...
        print "Above is your ad as it appears now. Click one of the items below to change your ad.<br>\n";
	print "<form action=$newform method=POST>\n";
	print "<input type=hidden name=action value=\"MakeEdit\">\n";
	print "<input type=radio name=EditItem value=TextAdFont>Font face<br>\n";
	print "<input type=radio name=EditItem value=TextAdFontColor>Font color<br>\n";
	print "<input type=radio name=EditItem value=TextAdText>Ad text<br>\n";
	print "<input type=radio name=EditItem value=TextAdUrl>Link url<br>\n";
	print "<input type=submit value=\"Edit this item\"></form>\n";
	print "<br><form action=$FinalizeScript method=POST>Or, if you're done editing this ad, \n";
	print "<input type=submit value=\"click here to finalize your changes\"></form>\n";
}
