...
$newform = "/cgi-bin/surflocal/IndexPage-winstonsalem.cgi";

$IndexTemplate = "$TemplatesDir" . "/cities/IndexTemplate-winstonsalem.html";
...
Surflocal Website <br>Creation Suite </a>";
	       		 print "</td>\n";
				$BCells++;
				$ThisLoop++;
		    	}	    
...
Two Dollars a Day Opens a
<br>Private Marketing Category 
</a>";
...
$TheCategory</font></a>";
 ...
 One Dollar a Day Opens 
<br>A New Coupon Category
    ...
    {
        print "<center><font color=ffffff>Click the link above to Start Your Coupon Ad</font></center>";
    }
}
