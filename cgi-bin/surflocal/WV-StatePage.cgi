...
$newform = "$baseurl" . "WV-StatePage.cgi";

$IndexTemplate = "$TemplatesDir" . "/state-pages/wv-us.html";
		...
		until ($ThisLoop == 5)
		{
			...
			$ThisLoop++;
				...
				$HandleUrl = "$HandleRequest" . "\?" . "Button" . "\&" . "$State" . "\&" . "$City";		
	       		 print "<td align='center' width='136' height='56' background='/images/5_6-out2.jpg'>";
	       		 print "<a href=\"$HandleUrl\">";
	       		 print "<font face=\"Tahoma\"><font size=-1>$City <br> Private Category
</a></b>";
	       		 print "</td>\n";
				$BCells++;
				$ThisLoop++;
...
sub GenerateCategories
{
	...
	for ($i = 0; $i <= $Divided; $i++)
	{
		...
		if ($PrintedCells < $Cats)
		{
		    ...
		    print "<a href=\"$CoupDisp\" class=\"roll\"><font color=FABE56>$TheCategory</font></a>
</b>";
