...
$newform = "/cgi-bin/surflocal/IndexPage-Splash-Page.cgi";

$IndexTemplate = "$TemplatesDir" . "/cities/IndexTemplate-Splash-Page.html";
...
National Press <br>Release Network</a>";
	       		 print "</td>\n";
				$BCells++;
				$ThisLoop++;
		    	}	    
...
sub LocalProductAds
{
    ...
    if ($TextExists ne "false")
    {
		...
		until ($ThisLoop == 4)
		{
			...
			print "<td WIDTH=183 HEIGHT=46 BGCOLOR=\"ffffff\" BACKGROUND=/images/btn-yellow-sn1.jpg><center><a href=\"$AdUrl\" target=\"_top\"><font face=\"$AdFont\" color=$AdFontColor><font size=+1>
...
$AdText</a>";
			...
			print "<a href=\"$AdDisp\" class=\"roll\" target=\"_top\"><font size=+1>

USA<br>Private Category
</a>";
    ...
    else
    	{
    		...
    		print "<tr><td>\n";
		print "<a href=\"$AdDis\" class=\"roll\" target=\"_new\">There are no Product and Service Ads for USA yet. Click Here To Create Your Ad</a><br>";
    		print "</td></tr>\n";
    	}
}
...
sub GenerateCategories
{
	...
	for ($i = 1; $i <= $Divided; $i++)
	{
		...
		if ($PrintedCells < $Cats)
		{
		    ...
		    print "<td WIDTH=183 HEIGHT=46 BACKGROUND=/images/btn-yellow-sn1.jpg><center>";
		    print "<a href=\"$CoupDisp\" class=\"roll\" target=\"_top\"><font size=+1>
