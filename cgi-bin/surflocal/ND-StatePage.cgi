...
$newform = "$baseurl" . "ND-StatePage.cgi";

$IndexTemplate = "$TemplatesDir" . "/state-pages/nd-us.html";
...
sub ButtonAds
{
    ...
    if ($NoButtons)
    {
    	...
    	for ($i=0; $i <= $IterationMax; $i++)
    	{
	        ...
	        print "<font size=-1><b>$City <br> Private Category
</a></b>";
	        print "</td>\n";
    	}
    }
...
sub GenerateCategories
{
	...
	for ($i = 0; $i <= $Divided; $i++)
	{
		...
		if ($PrintedCells < $Cats)
		{
		    ...
		    print "<a href=\"$CoupDisp\" class=\"roll\"><b>$TheCategory</font></a></b>";
		...
		else
		{
		    ...
		    print "<a href=\"$CoupDisp\" class=\"roll\">Your category here</font></a>";
