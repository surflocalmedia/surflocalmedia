...
$IndexTemplate = "$TemplatesDir" . "CREAL_ButtonTemp.html";
$CouponDisplay = "$baseurl" . "CouponDisplay.cgi";
$HandleRequest = "$baseurl" . "NewBeginAdDB.cgi";
		...
		until ($ThisLoop == 5)
		{
			...
			$ThisLoop++;
				...
				$HandleUrl = "$HandleRequest" . "\?" . "Button" . "\&" . "$State" . "\&" . "$City";		
	       		 print "<td align='center' width='136' height='56' background='$imgdr/5_4-out2.jpg'>";
	       		 print "<a href=\"$HandleUrl\">";
	       		 print "<font face=\"Georgia\"><strong>Link Your Site Here</strong></a>";
	       		 print "</td>\n";
				$BCells++;
				$ThisLoop++;
		    	}	    
