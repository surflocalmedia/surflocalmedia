...
####### VARIABLES #######
$newform = "/cgi-bin/surflocal/BeginAdDB.cgi";
...
<tr><td>\n";
    ...
    if ($AdType eq "Button")
    {
	print " <input type=radio name=AdType value=ButtonOnly><i><font color=000000><b>Marketing Link</i></b><br><br><br>\n";
	print " <input type=radio name=AdType value=ButtonPlus><i><b>Marketing link and Webpage</i></b><br><br>\n";
    }
    elsif ($AdType eq "TextAd")
    {
        print " <input type=radio name=AdType value=TextAdOnly><i><b>Marketing link</i></b><br><br>\n";
	print " <input type=radio name=AdType value=TextAdPlus><i><b>Marketing link and Webpage</i></b> <br></i>\n";
    }
