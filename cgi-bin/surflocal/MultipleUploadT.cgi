...
#####set variables here######
$newform = "/cgi-bin/surflocal/MultipleUploadT.cgi";
...
sub DoTheUpload
{
	...
	$ButtonFile = "$basedir" . "$City" . "/" . "Text.data";#contains pipe-delimited data
...
\"><br><br></center>\n";
	print "<h1><font color=000040>WELL DONE...</h1>\n";
...
sub SelectButton
{
	...
	open(BTN,"$ButtonFile") or $NoButtons="true";
    	...
    	{
    		&Error("This city doesn't have any TEXT ADS. To upload a TEXT AD to multiple towns, the TEXT AD must first exist.");
    	}
    	else
    	{
    		&Header;
print "<link href=\"/styleC.css\" rel=\"stylesheet\" type=\"text/css\" />\n";
        print "<center><img src=\"http://surflocal.net/\sm_banner_MKTG.jpg
\"><br><br></center>\n";
		print "<h1><font color=000040>Select a TEXT AD to upload</h1>\n";
...
print "<link href=\"/styleC.css\" rel=\"stylesheet\" type=\"text/css\" />\n";
        print "<center><img src=\"http://surflocal.net/\sm_banner_MKTG.jpg
\"><br><br></center>\n";
	print "<h1><font color=000040>Select the city where your button is</h1>\n";
...
{
	&Header;
	open(CHOOSE,"$basedir" . "Templates" . "/" . "ChooseCitiesT.html") || &Error("Can't open the cities file. Reason: $!");
	while(<CHOOSE>)
	{
		if ($_ =~ /\%\%ListOfCities\%\%/)
		{
