...
$newform = "/cgi-bin/surflocal/Realestate-IndexPage.cgi";

$IndexTemplate = "$TemplatesDir" . "Realestate-CREAL_ButtonTemp.html";
...
sub ButtonAds
{
    ...
    if ($NoButtons)
    {
    	...
    	for ($i=0; $i <= $IterationMax; $i++)
    	{
	        ...
	        print "<font face=\"Georgia\">Self Serve Real Estate</a>";
	        print "</td>\n";
    	}
    }
    else
		...
		until ($ThisLoop == 5)
		{
			...
			$ThisLoop++;
				...
				$HandleUrl = "$HandleRequest" . "\?" . "Button" . "\&" . "$State" . "\&" . "$City";		
	       		 ...
	       		 print "<a href=\"$HandleUrl\">";
	       		 print "$State Real Estate for Sale</a>";
	       		 print "</td>\n";
				$BCells++;
				$ThisLoop++;
		    	}	    
